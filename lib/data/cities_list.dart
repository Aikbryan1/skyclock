...
final List<City> cities = [
  ...
  // More major cities (not capitals, but widely searched)
  City(name: 'Shanghai', country: 'China', timezone: 'Asia/Shanghai'),
  City(name: 'Guangzhou', country: 'China', timezone: 'Asia/Shanghai'),
  City(name: 'Shenzhen', country: 'China', timezone: 'Asia/Shanghai'),
  City(name: 'Osaka', country: 'Japan', timezone: 'Asia/Tokyo'),
  City(name: 'Busan', country: 'South Korea', timezone: 'Asia/Seoul'),
  City(name: 'Bangalore', country: 'India', timezone: 'Asia/Kolkata'),
  City(name: 'Chennai', country: 'India', timezone: 'Asia/Kolkata'),
  City(name: 'Kolkata', country: 'India', timezone: 'Asia/Kolkata'),
  City(name: 'Barcelona', country: 'Spain', timezone: 'Europe/Madrid'),
  City(name: 'Munich', country: 'Germany', timezone: 'Europe/Berlin'),
  City(name: 'Frankfurt', country: 'Germany', timezone: 'Europe/Berlin'),
  City(name: 'Milan', country: 'Italy', timezone: 'Europe/Rome'),
  City(name: 'Manchester', country: 'UK', timezone: 'Europe/London'),
  City(name: 'Edinburgh', country: 'UK', timezone: 'Europe/London'),
  City(name: 'Houston', country: 'USA', timezone: 'America/Chicago'),
  City(name: 'Miami', country: 'USA', timezone: 'America/New_York'),
  City(name: 'Boston', country: 'USA', timezone: 'America/New_York'),
  City(name: 'San Francisco', country: 'USA', timezone: 'America/Los_Angeles'),
  City(name: 'Seattle', country: 'USA', timezone: 'America/Los_Angeles'),
  City(name: 'Atlanta', country: 'USA', timezone: 'America/New_York'),
  City(name: 'Montreal', country: 'Canada', timezone: 'America/Toronto'),
  City(name: 'Calgary', country: 'Canada', timezone: 'America/Edmonton'),
  City(name: 'Monterrey', country: 'Mexico', timezone: 'America/Monterrey'),
  City(name: 'Medellín', country: 'Colombia', timezone: 'America/Bogota'),
  City(
    name: 'Cape Town',
    country: 'South Africa',
    timezone: 'Africa/Johannesburg',
  ...
  City(name: 'Alexandria', country: 'Egypt', timezone: 'Africa/Cairo'),
  City(name: 'Brisbane', country: 'Australia', timezone: 'Australia/Brisbane'),
  City(name: 'Adelaide', country: 'Australia', timezone: 'Australia/Adelaide'),
  City(
    name: 'Christchurch',
    country: 'New Zealand',
